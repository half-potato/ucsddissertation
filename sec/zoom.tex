...
\pgfkeys{/tikz/.cd,
    ...
    zoomboxarray inner gap/.initial=3pt,
    zoomboxarray columns/.initial=1,
    ...
    zoomboxarray/.style={
        ...
        execute at end picture={
            \end{scope}
            \node at (image.north) [anchor=north,inner sep=0pt] {\phantomimage};
            \node at (zoomboxes container.north) [anchor=north,inner sep=0pt] {\phantomimage};
     \gdef\patternnumber{0}
        },
...
\newcommand\zoombox[2][]{
    \begin{scope}[zoombox paths]
        \pgfmathsetmacro\xpos{
            (\columncount-1)*(\imagewidth / \pgfkeysvalueof{/tikz/zoomboxarray columns} + \pgfkeysvalueof{/tikz/zoomboxarray inner gap} / \pgfkeysvalueof{/tikz/zoomboxarray columns} )
        }
        \pgfmathsetmacro\ypos{
            (\rowcount-1)*( \imageheight / \pgfkeysvalueof{/tikz/zoomboxarray rows} + \pgfkeysvalueof{/tikz/zoomboxarray inner gap} / \pgfkeysvalueof{/tikz/zoomboxarray rows} )
        }
        \edef\dospy{\noexpand\spy [
            #1,
            zoombox paths/.append style={
